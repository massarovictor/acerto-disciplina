// Slide for Ciências Humanas e suas Tecnologias
...
interface HumanitiesAreaSlideProps {
  grades: Grade[];
  period: string;
}

export const HumanitiesAreaSlide = ({ grades, period }: HumanitiesAreaSlideProps) => {
  const area = SUBJECT_AREAS.find(a => a.name === 'Ciências Humanas e suas Tecnologias')!;
  ...
  return (
    <div className="h-full p-8 bg-gradient-to-br from-purple-500/5 to-background flex flex-col">
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            <BookOpen className="h-8 w-8 text-purple-600" />
            <div>
              <h1 className="text-3xl font-bold">Ciências Humanas e suas Tecnologias</h1>
          ...
          {period === 'all' && trendData.length > 0 && (
            <Card className="bg-card/50 backdrop-blur">
              <CardContent className="pt-6">
                ...
                <LineChart data={trendData} height={80} color="rgb(147, 51, 234)" />
              </CardContent>
            </Card>
          )}
