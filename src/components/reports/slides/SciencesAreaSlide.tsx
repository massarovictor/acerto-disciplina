// Slide for Ciências da Natureza e suas Tecnologias
...
interface SciencesAreaSlideProps {
  grades: Grade[];
  period: string;
}

export const SciencesAreaSlide = ({ grades, period }: SciencesAreaSlideProps) => {
  const area = SUBJECT_AREAS.find(a => a.name === 'Ciências da Natureza e suas Tecnologias')!;
  ...
  return (
    <div className="h-full p-8 bg-gradient-to-br from-green-500/5 to-background flex flex-col">
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            <BookOpen className="h-8 w-8 text-green-600" />
            <div>
              <h1 className="text-3xl font-bold">Ciências da Natureza e suas Tecnologias</h1>
          ...
          {period === 'all' && trendData.length > 0 && (
            <Card className="bg-card/50 backdrop-blur">
              <CardContent className="pt-6">
                ...
                <LineChart data={trendData} height={80} color="rgb(34, 197, 94)" />
              </CardContent>
            </Card>
          )}
